    ...
    $(document).ready(function() {
        ...
        $("#form-tambah-edit").validate({
            ...
            rules: {
                ...
                nama_paket: { required: true },
                perangkat_daerah: { required: true },
                rekening_kegiatan: { required: true },
                sumber_dana: { required: true },
                pagu_anggaran: { required: true },
                pagu_hps: { required: true },
                jenis_pengadaan: { required: true },
                metode_pengadaan: { required: true }
            },
            messages: {
